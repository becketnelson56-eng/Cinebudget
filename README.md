# Cinebudget
Cinebudget
AI-powered film production budget tool for independent filmmakers and line producers.
...
AI: Claude Sonnet (5 grouped API calls per script, full PDF passed as base64 document)
